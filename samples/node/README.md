...
| `node:22` | ![Size](https://img.shields.io/static/v1?label=Size&message=389.07+MB&color=blue) | ![Vulns](https://img.shields.io/static/v1?label=Security&message=299+Vulns+%286+Crit%29&color=red) | 99.4% | `linux/amd64, linux/arm, linux/arm64, linux/ppc64le, linux/s390x, unknown/unknown` |
| `node:24` | ![Size](https://img.shields.io/static/v1?label=Size&message=388.59+MB&color=blue) | ![Vulns](https://img.shields.io/static/v1?label=Security&message=290+Vulns+%286+Crit%29&color=red) | 99.4% | `linux/amd64, linux/arm64, linux/ppc64le, linux/s390x, unknown/unknown` |
...
<details>
<summary><strong>👇 Expand Vulnerability Details (1029 found)</strong></summary>
