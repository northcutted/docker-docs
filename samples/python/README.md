...
| `python:3.10-slim` | ![Size]() | ![Vulns](https://img.shields.io/static/v1?label=Security&message=41+Vulns+%280+Crit%29&color=orange) | 0.0% | / |
| `python:3.11-slim` | ![Size]() | ![Vulns](https://img.shields.io/static/v1?label=Security&message=39+Vulns+%280+Crit%29&color=orange) | 0.0% | / |
